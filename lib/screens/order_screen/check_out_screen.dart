                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Material(
                                    elevation: 0.0,
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'SSLCommerz' ? primaryColor : isDark?darkContainer:secondaryColor3)),
                                    color: isDark?darkContainer:Colors.white,
                                    child: CheckboxListTile(
                                  ...
                                  Material(
                                    elevation: 0.0,
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Flutterwave' ? kPrimaryColor : isDark?darkContainer:secondaryColor3)),
                                    color: isDark ? darkContainer : Colors.white,
                                    child: CheckboxListTile(
                                  ...
                                  Material(
                                    elevation: 0.0,
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Webview' ? kPrimaryColor : isDark?darkContainer: secondaryColor3)),
                                    color: isDark ? darkContainer : Colors.white,
                                    child: CheckboxListTile(
    ...
    switch (whichPaymentIsChecked) {
      ...
      case 'Paytm':
        PaytmConfig().generateTxnToken(
            widget.couponPrice == null ? cart.cartTotalPriceF(initialValue) : (cart.cartTotalPriceF(initialValue) - cart.promoPrice), DateTime.now().millisecondsSinceEpoch.toString());
        break;
      case 'Webview':
